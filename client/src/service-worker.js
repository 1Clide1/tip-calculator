...
// workbox imports for the service worker
...
registerRoute(
  ...
  new CacheFirst({
    cacheName: "images",
    plugins: [
      // make sure the status response is a 200 before you cache it
...
const URLS = [
  ...
  "/favicon/apple-touch-icon-iphone-60x60.png",
  "/favicon/apple-touch-icon-ipad-76x76.png",
  "/favicon/apple-touch-icon-iphone-retina-120x120.png",
  "/favicon/apple-touch-icon-ipad-retina-152x152.png",
